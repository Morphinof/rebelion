...
/**
 * The rebelion.combat.proxy_card.discarded event is dispatched each time a card is discarded in the system.
 */
class ProxyCardDiscarded extends Event
{
    const NAME = 'rebelion.event.combat.proxy_card.discarded';
